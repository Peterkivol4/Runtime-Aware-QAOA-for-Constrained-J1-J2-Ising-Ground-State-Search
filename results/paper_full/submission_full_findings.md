...
- **bo_fourier_auc**: -0.23106287441494455
- **spsa_fourier_auc**: -0.23091405223708467
- **p_value_gap**: 1.0
- **p_value_ratio**: 1.0
- **winner**: bo_fourier
- **delta_auc**: 0.00014882217785988638

### Does readout mitigation + ZNE materially improve feasible-energy quality under shot noise?
- **mean_gain**: 0.0
- **mean_psucc_gain**: 0.005549074356794198
...
- **worst_valid_ratio_window**: {'method': 'spsa_fourier', 'regime': 'clustered', 'n_assets': 8, 'budget': 4, 'depth': 1, 'noise_level': 0.0, 'mean_valid_ratio': 0.24593776330003422}
...
- qaoa::random_fourier | mitigation=readout+zne | mean_ratio=1.000000 | P_succ=0.1481 | runtime=0.0084s | shots=4640.0
- qaoa::bo_direct | mitigation=readout+zne | mean_ratio=1.000000 | P_succ=0.1537 | runtime=0.0091s | shots=4640.0
- qaoa::random_fourier | mitigation=none | mean_ratio=1.000000 | P_succ=0.1359 | runtime=0.0104s | shots=3871.7
- qaoa::random_fourier | mitigation=readout | mean_ratio=1.000000 | P_succ=0.1363 | runtime=0.0109s | shots=3871.7
