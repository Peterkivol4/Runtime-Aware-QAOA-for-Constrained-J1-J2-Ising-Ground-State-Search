...
- **bo_fourier_auc**: -0.23106359520049846
- **spsa_fourier_auc**: -0.23096438041525855
- **p_value_gap**: 1.0
- **p_value_ratio**: 1.0
- **winner**: bo_fourier
- **delta_auc**: 9.9214785239915e-05

### Does readout mitigation + ZNE materially improve feasible-energy quality under shot noise?
- **mean_gain**: 0.0
- **mean_psucc_gain**: 0.004715590582392891
...
- **worst_valid_ratio_window**: {'method': 'spsa_fourier', 'regime': 'clustered', 'n_assets': 8, 'budget': 4, 'depth': 1, 'noise_level': 0.0, 'mean_valid_ratio': 0.24795145164835392}
...
- qaoa::random_fourier | mitigation=readout+zne | mean_ratio=1.000000 | P_succ=0.1467 | runtime=0.0078s | shots=7200.0
- qaoa::bo_direct | mitigation=readout+zne | mean_ratio=1.000000 | P_succ=0.1494 | runtime=0.0082s | shots=7200.0
- qaoa::random_fourier | mitigation=none | mean_ratio=1.000000 | P_succ=0.1340 | runtime=0.0092s | shots=6005.2
- qaoa::random_fourier | mitigation=readout | mean_ratio=1.000000 | P_succ=0.1344 | runtime=0.0100s | shots=6005.2
